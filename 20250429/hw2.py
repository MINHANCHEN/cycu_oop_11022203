...
class taipei_route_info:
    ...
    def plot_route_map(self, output_path: str):
        ...
        # 讀取人的圖片
        person_img = mpimg.imread(r'C:\Users\User\Documents\GitHub\cycu_oop_11022203\人.jpg')
        for xi, yi in zip(x, y):
            ab = AnnotationBbox(OffsetImage(person_img, zoom=0.1), (xi, yi), frameon=False)
            plt.gca().add_artist(ab)

        # 讀取公車圖片
        bus_img = mpimg.imread(r'C:\Users\User\Documents\GitHub\cycu_oop_11022203\公車.png')
        for xi, yi in zip(x, y):
...
if __name__ == "__main__":
    ...
    for route_id in bus_list:
        try:
            ...
            route_info.plot_route_map(map_path)
